...
<CardGrid>
  ...
  <Card title="Decision Making" icon="approve-check">
    [Reducing decision fatigue](/decision-making-errors/biases-heuristics/) through simplified choices.
  </Card>
</CardGrid>
...
- [Smart Defaults - iOS Camera](/examples/cognitive-load/smart-defaults-ios-camera/) - Eliminate decisions with intelligent defaults
