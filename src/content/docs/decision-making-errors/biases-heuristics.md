...
description: Recognize and mitigate decision pitfalls in UI choice architecture.
---
...
The Nielsen Norman Group [updated their Psychology for UX Study Guide in April 2025](https://www.nngroup.com/articles/psychology-study-guide/), covering how cognitive biases and heuristics are mental shortcuts people use to save themselves from doing extra mental work when making sense of the world.

### Key Findings on UI Decision-Making

Recent research emphasizes that recognizing and addressing cognitive biases is essential to enhancing user decision-making and minimizing mental friction. [Analysis of cognitive biases in interface design](https://www.sciencedirect.com/science/article/pii/S1877050924002746) (2024) shows that systematic deviations from rational judgment significantly impact how users interpret information.
...
**Recent Research:**
- [Psychology for UX: Study Guide](https://www.nngroup.com/articles/psychology-study-guide/) — NN/g (Updated April 2025)
- [Considering cognitive biases in design: an integrated approach](https://www.sciencedirect.com/science/article/pii/S1877050924002746) (2024)

---

## See Also

- [Error Types](/decision-making-errors/error-types/) — How biases lead to mistakes
- [Defensive Design](/decision-making-errors/defensive-design/) — Protecting users from their own errors
- [Confusion](/cognition/confusion/) — How cognitive biases create confusion
