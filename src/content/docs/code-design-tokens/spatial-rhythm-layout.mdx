...
import SpatialRhythmExamples from '../../../components/SpatialRhythmExamples.astro';
...
These diagrams deliberately omit pixel labels. They demonstrate which spaces
should be closer or farther apart; the product still decides the values.

<SpatialRhythmExamples />
