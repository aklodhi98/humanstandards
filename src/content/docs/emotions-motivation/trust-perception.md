...
description: How users form trust judgments, the psychological foundations of credibility, and why dark patterns destroy long-term relationships.
---
...
## How users form trust judgments

### The speed of credibility assessment
...
## Trust signals in interface design
...
## Dark patterns and trust destruction
...
### Common dark patterns that destroy trust
...
Research presented at [ENASE 2025](https://www.scitepress.org/Papers/2025/134327/134327.pdf) on "Exploring the Influence of User Interface on User Trust in Generative AI" found that trust in AI chatbots is influenced by anthropomorphism, competency, trustworthiness, and social presence. Interface design directly influences perceived trustworthiness and affects users' intention to use AI tools.

### Dark Patterns and Brand Equity

A 2025 study published in [Internet Research](https://www.emerald.com/intr/article-abstract/doi/10.1108/INTR-07-2024-1026/1255236/Dark-patterns-dimmed-brands-the-erosion-of-equity) titled "Dark patterns, dimmed brands" examines how e-commerce companies employ deceptive techniques to manipulate customer decisions. The research finds that dark patterns generate negative emotions in consumers, which is detrimental to brand experience and consumer-based brand equity.

### Trust Erosion Quantified

A [2025 systematic review](https://journalwjarr.com/sites/default/files/fulltext_pdf/WJARR-2025-0691.pdf) on "The impact of dark patterns on user trust and long-term engagement" found that 56% of users report losing trust due to manipulative design, with 43% stopping purchases from retailers after experiencing dark patterns. The research documents emotional distress, financial loss, and erosion of trust as long-term consequences.

### User Knowledge and Susceptibility

Research on ["The Effect of Dark Patterns and User Knowledge on User Experience and Decision-Making"](https://www.researchgate.net/publication/379722457_The_Effect_of_Dark_Patterns_and_User_Knowledge_on_User_Experience_and_Decision-Making) found that users without knowledge of dark patterns were significantly more susceptible to manipulation. In confirmshaming conditions, **68% of unknowledgeable users** chose the expensive plan, compared to much lower rates among educated users.

### Comprehensive Dark Pattern Taxonomy

A [comprehensive 2024 study on dark patterns](https://arxiv.org/html/2412.09147v1) provides updated typologies of deceptive design strategies, analyzing their psychological underpinnings and real-world applications across digital platforms. The research emphasizes that dark patterns exploit cognitive biases systematically.

### Regulatory Enforcement Acceleration

The [EU Digital Services Act](https://cbtw.tech/insights/dark-patterns-in-ux-short-term-wins-long-term-business-risks), fully effective since February 2024, directly addresses dark patterns by prohibiting online interfaces that "deceive, manipulate, or otherwise materially distort" a user's ability to make free and informed decisions. The FTC's 2024 action against Amazon for Prime cancellation design signals increased enforcement in the US as well.

### Socio-Technical Trust Systems

Research published for [INTERACT 2025](https://link.springer.com/chapter/10.1007/978-3-032-05008-3_3) on "Designing Trustworthy Technology" highlights that system design shapes users' perception of trust within socio-technical contexts. Inappropriate trust calibration (overtrust or distrust) negatively affects user well-being and limits system adoption, especially in high-risk domains like healthcare and finance.
...
**Foundational Work:**
- [Stanford Web Credibility Project](https://credibility.stanford.edu/) — Seminal research on web credibility
- Fogg, B.J. — Persuasive Technology and Credibility Research
- [Trust or Bust: Communicating Trustworthiness in Web Design](https://www.nngroup.com/articles/communicating-trustworthiness/) — NN/g

**Official Standards:**
- [Mozilla Data Privacy & Permissions Best Practices](https://developer.mozilla.org/docs/Web/Privacy/Principles)
- EU Digital Services Act — Dark pattern prohibitions (2024)
- FTC Guidelines on Deceptive Design Practices

**Recent Research:**
- [Exploring the Influence of User Interface on User Trust in Generative AI](https://www.scitepress.org/Papers/2025/134327/134327.pdf) — ENASE 2025
- [Dark patterns, dimmed brands: the erosion of equity](https://www.emerald.com/intr/article-abstract/doi/10.1108/INTR-07-2024-1026/1255236/Dark-patterns-dimmed-brands-the-erosion-of-equity) — Internet Research (2025)
- [The impact of dark patterns on user trust](https://journalwjarr.com/sites/default/files/fulltext_pdf/WJARR-2025-0691.pdf) — WJARR (2025)
- [A Comprehensive Study on Dark Patterns](https://arxiv.org/html/2412.09147v1) (2024)
- [Designing Trustworthy Technology](https://link.springer.com/chapter/10.1007/978-3-032-05008-3_3) — INTERACT 2025

**Practical Resources:**
- [Design for Trust: Insights from Psychology on Credibility](https://www.fraukeseewald.com/design-for-trust/)
...
- [What is Credibility?](https://www.interaction-design.org/literature/topics/credibility) — IxDF
- [Trust Signals: Building Credibility Through Design](https://spyderserve.com/blog/trust-signals-building-credibility-through-design/)

---

## See Also

- [Motivation Models](/emotions-motivation/motivation-models/) — Ethical persuasion and dark pattern avoidance
- [Biases & Heuristics](/decision-making-errors/biases-heuristics/) — Cognitive biases that affect trust judgments
- [Confusion](/cognition/confusion/) — How confusion destroys trust
- [WCAG Guidelines](/accessibility/wcag-guidelines/) — Accessibility as trust signal
- [Defensive Design](/decision-making-errors/defensive-design/) — Protecting users builds trust
